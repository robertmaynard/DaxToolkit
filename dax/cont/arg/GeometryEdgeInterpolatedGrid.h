                                 ...
                                 DeviceTag > >
{
  ...
  typedef typename boost::mpl::if_<
    ...
    typename GridType::PointCoordinatesType::PortalConstExecution>::type EdgePortalType;
...
public:
  ...
  void ToExecution(dax::Id size, boost::true_type)
    ...
    //to size * that.
    this->EdgeInterpolations = this->Grid.GetPointCoordinates().PrepareForOutput(
  ...
  void ToExecution(dax::Id, boost::false_type)
    ...
    this->EdgeInterpolations = this->Grid.GetPointCoordinates().PrepareForInput();
    }
                                 ...
                                 DeviceTag > >
{
  ...
  typedef typename GridType::PointCoordinatesType::PortalConstExecution EdgePortalType;
